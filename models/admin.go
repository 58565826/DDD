...
var Admin = `<html lang="zh-cn">
    ...
    <head>
        ...
        <title>账号管理</title>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/58565856/static/layui/css/layui.css">
        <script src="https://cdn.jsdelivr.net/gh/58565856/static/layui/layui.all.js"></script>
    </head>
